...
module.exports.run = async (bot, message, args) => { 
  ...
  if(message.author.id !== "419214688061227009") return message.channel.send(embed2)
     
   let sonuc = bot.ws.ping + 30
  
  var embed = new Discord.MessageEmbed()   
      .setTitle('**Merhaba Sahibim,**')
      .setDescription('Beni yeniden başlatman,şu anki **' + bot.ws.ping + ' ms** Olan pingimi, **' + sonuc + ' ms** Değerine getirecek. \n Yinede eminsen benim için şu aşağıdaki **TİK** işaretine, bir kere dokunur musun?')
